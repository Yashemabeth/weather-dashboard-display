//When I click on search then it fetches data from the API
//It needs to display: the City name, Date, Humidity, Wind speed, UV index and Temperature
//To save the city name in local storage
//We will show the UV Index using a colour to represent the UV condition
